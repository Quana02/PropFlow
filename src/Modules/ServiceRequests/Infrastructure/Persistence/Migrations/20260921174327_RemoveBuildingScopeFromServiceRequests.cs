...
{
    /// <inheritdoc />
    public partial class RemoveBuildingScopeFromServiceRequests : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    UPDATE service_requests.service_requests
                    SET building_id = singleton_building_id
                    WHERE building_id IS NULL;

                    ALTER TABLE service_requests.service_requests
